...
#define aranya_DeviceDeleteCmd_ids_tag           1
#define aranya_DeviceListCmd_ids_tag             1
...
#define aranya_DeviceOperateCmd_device_id_tag    1
...
X(a, CALLBACK, REPEATED, STRING,   ids,               1)
