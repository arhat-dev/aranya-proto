...
var fileDescriptor_77a6da22d6a3feb1 = []byte{
	...
	0x73, 0x21, 0x82, 0x46, 0x46, 0x5c, 0x5c, 0xae, 0x29, 0xe9, 0xa9, 0x2e, 0xa9, 0x65, 0x99, 0xc9,
	0xa9, 0x42, 0x2a, 0x5c, 0x2c, 0xc1, 0x95, 0x79, 0xc9, 0x42, 0xdc, 0x7a, 0x10, 0xb5, 0x7a, 0xbe,
	0xc5, 0xe9, 0x52, 0x70, 0x8e, 0x73, 0x6e, 0x8a, 0x06, 0xa3, 0x01, 0xa3, 0x53, 0xf8, 0x85, 0x87,
	...
	0xe1, 0xc6, 0x63, 0x39, 0x86, 0x28, 0xc5, 0xc4, 0xa2, 0x8c, 0xc4, 0x12, 0xbd, 0x94, 0xd4, 0x32,
	0x7d, 0x88, 0x79, 0xba, 0x60, 0x17, 0x40, 0x39, 0xe9, 0xf9, 0x05, 0x49, 0x49, 0x6c, 0x60, 0x11,
	0x63, 0x40, 0x00, 0x00, 0x00, 0xff, 0xff, 0xb5, 0x93, 0x38, 0x77, 0xb5, 0x00, 0x00, 0x00,
}
...
func (x *edgeDeviceSyncClient) Send(m *Msg) error {
	return x.ClientStream.SendMsg(m)
}

func (x *edgeDeviceSyncClient) Recv() (*Cmd, error) {
	m := new(Cmd)
...
func (x *edgeDeviceSyncServer) Send(m *Cmd) error {
	return x.ServerStream.SendMsg(m)
}

func (x *edgeDeviceSyncServer) Recv() (*Msg, error) {
	m := new(Msg)
